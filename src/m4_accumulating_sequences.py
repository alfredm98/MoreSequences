...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        corner_1 = rg.Point(circles[k].radius + circles[k].center.x, -circles[k].radius + circles[k].center.y)
        corner_2 = rg.Point(-circles[k].radius + circles[k].center.x, circles[k].radius + circles[k].center.y)
